...
class _$TodoTearOff {
  ...
  _Todo call(
      {int? id, String title = '', @JsonKey(name: 'is_done') int isDone = 0}) {
    return _Todo(
      id: id,
      title: title,
      isDone: isDone,
...
abstract class $TodoCopyWith<$Res> {
  ...
  $Res call({int? id, String title, @JsonKey(name: 'is_done') int isDone});
}
...
class _$_Todo implements _Todo {
  const _$_Todo(
      {this.id, this.title = '', @JsonKey(name: 'is_done') this.isDone = 0});
...
abstract class _Todo implements Todo {
  const factory _Todo(
      {int? id, String title, @JsonKey(name: 'is_done') int isDone}) = _$_Todo;
